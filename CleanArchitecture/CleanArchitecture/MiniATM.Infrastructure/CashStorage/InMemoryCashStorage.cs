...
{
    private ILogger<InMemoryCashStorage> logger;
    ...
    {
        this.logger = logger;
        this.availableAmount = initAmount;
        logger.LogInformation("CashStorage loaded with amount = {AvailableAmount}", availableAmount);
    }
